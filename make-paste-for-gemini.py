"""
Bundles all project source files into a single text and copies it to the clipboard
via OSC 52, so you can paste it into Gemini (or any LLM chat) for context.

IMPORTANT: Must be run inside Windows Terminal (not VS Code's integrated terminal,
CMD, or PowerShell directly). Windows Terminal supports the OSC 52 clipboard
escape sequence required for the copy-to-clipboard feature to work.

Usage:
    python make-paste-for-gemini.py
"""
import os
import base64
import sys
